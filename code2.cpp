...
int main() {
    ...
    while (true) {
        ...
        case 1:
            cout << "\nСоздаем неотсортированный массив из 100 элементов: ";
            for (int i = 0; i < n; i++) {
                arr1[i] = rand() % 199 - 99;
                arr2[i] = arr1[i];
                cout << arr1[i] << " ";
        ...
        case 2:
            nm = n - 1;
            cout << "\nПолучаем отсортированный массив из 100 элементов: ";
            s = steady_clock::now();
            for (int j = 0; j < n; j++) {
        ...
        case 4:
            ...
            sr /= 2;
            cout << "\nСреднее значение max и min: " << sr << endl << endl;
